...
export function ProductAddDialog({ open, onOpenChange }: Props) {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    mutation.mutate({...values,category_id:Number(values.category_id),manufacturer_id:Number(values.manufacturer_id)})
  }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="مثال: باراسيتامول 500 مجم" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
